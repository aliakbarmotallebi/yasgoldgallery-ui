...
const Cart = () => {
  ...
  return (
    <div className="col-span-1 lg:col-span-2 overflow-hidden">
      <div className="flex items-center justify-between border-b border-gray-50 px-4 py-5">
        <h1 className="font-semibold text-lg">سبد خرید شما</h1>
        <h2 className="font-semibold text-xs text-gray-800">
