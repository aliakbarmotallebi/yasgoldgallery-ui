            ...
            <div className="relative">
              ...
              <div className="absolute bottom-5 right-5 ">
                <button class="flex items-center bg-white px-4 py-1 rounded-lg overflow-hidden shadow-lg w-full text-neutral-900 hover:bg-gray-200 font-medium">
                  <div className="text-xs ml-2">200,000,000 تومان</div>
                  <div className="text-xs ml-2 text-yellow-400">
                    خرید
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="max-w-sm">
            <div className="relative">
              ...
              <div className="absolute bottom-5 right-0 w-full mx-auto px-5">
                <button class="flex items-center bg-white px-4 py-1 rounded-lg overflow-hidden shadow-lg w-full text-neutral-900 hover:bg-gray-200 font-medium">
                  <div className="text-xs ml-auto ml-2">200,000,000 تومان</div>
                  خرید
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="inline fill-current"
                ...
                <ul role="list" class="space-y-2">
                  ...
                  <li className="bg-neutral-800 rounded-lg px-4 py-1">
                    <div className="inline-flex items-center space-x-2 space-x-reverse">
                      ...
                      <div className="text-xs text-white-200">
                        <div className="font-bold mb-1">شماره همراه مدیریت</div>
                        012-12345678
                      </div>
                    </div>
                  </li>
