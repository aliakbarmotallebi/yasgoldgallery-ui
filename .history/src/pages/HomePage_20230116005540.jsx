    ...
    <>
      <div class="flex flex-col justify-center">
        <div class="relative h-[390px]">
          <img class="hidden sm:block w-full h-full object-cover" src="https://picsum.photos/id/1/1920/400" />
          <img class="sm:hidden w-full h-full object-cover" src="https://picsum.photos/id/1/1920/400" />
