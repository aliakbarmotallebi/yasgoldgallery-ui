        ...
        <>
            <div className="bg-gray-100 px-4 xl:px-4 py-14">
                ...
                <div className="text-2xl text-black tracking-wider">
                    ...
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id rerum ipsum vero cumque facere reiciendis eius, omnis repellat delectus suscipit molestias fugiat aspernatur nulla architecto dolorum placeat doloribus minus? Fuga?
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, accusantium. Neque iste commodi provident mollitia possimus laborum maiores ad illo corporis, eius enim, saepe inventore laboriosam porro! In, repellendus consectetur!
                </div>
            </div>
        </>
    );
