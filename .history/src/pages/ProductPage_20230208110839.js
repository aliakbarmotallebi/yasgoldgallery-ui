    ...
    <div class="bg-[#4d4845] px-4 xl:px-4 py-14">
      ...
      <div className="container mx-auto">
        <div class="max-w-xl lg:max-w-6xl mx-auto text-neutral-900  bg-neutral-900 rounded-lg shadow-md  text-black px-5 py-6">
          ...
          <div className="px-10">
              <div>
                <div class="border-b-2 border-white text-lg text-yellow-500 pb-2 inline-flex items-center font-bold">
                  توضیحات
                </div>
                <div
                  dangerouslySetInnerHTML={{ __html: replaceWithBr(description) }}
                  className="pb-10 text-lg leading-7 text-white pt-2 px-4"
                ></div>
              </div>
              <div className="pt-5">
                <div class="border-b-2 border-white text-lg text-yellow-500 pb-2 inline-flex items-center font-bold">
