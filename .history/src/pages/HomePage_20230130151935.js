      ...
      <div class="flex flex-col justify-center">
        <div class="relative h-screen overflow-hidden">
          ...
          <div class="absolute bottom-0 left-0 w-full ">
            <div class="">
              <div class="flex justify-between px-10 translate-y-56">
                <div class="">
                  <div class="w-20 h-20">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="fill-neutral-800 bg-transparent w-full" viewBox="0 0 1440 320">
