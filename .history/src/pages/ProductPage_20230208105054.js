      ...
      <div class="container mx-auto">
        <div class="max-w-xl lg:max-w-6xl mx-auto text-neutral-900  bg-neutral-900 rounded-lg shadow-md  text-black px-5 py-6">
          <div class="flex flex-wrap -mx-4 mb-12 p-10">
              ...
              <div class="max-w-lg">
                ...
                <div class="px-3 rounded-md py-4 border border-yellow-600">
                  <div class="text-base text-yellow-700 pb-4 inline-flex items-center font-bold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-yellow-600 ml-1" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 18.26l-7.053 3.948 1.575-7.928L.587 8.792l8.027-.952L12 .5l3.386 7.34 8.027.952-5.935 5.488 1.575 7.928z"/></svg>
                    شرایط اقساط در یاس
                  </div>
            ...
            <div></div>
            <div class="pt-5">
            <div class="text-base text-yellow-600 pb-4 inline-flex items-center font-bold">
              توضیحات
            </div>
          <div
