            ...
            <div class="w-full lg:w-1/2 px-4">
              <div class="max-w-lg">
                <div className="flex items-center">
                  ...
                  {!loading && (
                    <HandleCart
                      ...
                      btnStyle="inline-flex items-center shuffle-click hidden sm:flex py-2 px-3 bg-brand-blue hover:opacity-70 bg-yellow-700 text-black text-xs font-semibold rounded"
                ...
                <ul class="list-inside font-medium mb-6">
                  <li>
                    <span className="text-bold after:content-[':'] text-white ml-2">
                      بارکد
                    </span>
                    {barcode}
                  </li>
