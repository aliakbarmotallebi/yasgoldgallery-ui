    ...
    <div class="container mx-auto mt-10">
      <div class="flex shadow-md my-10">
        <div class="w-3/4 bg-white rounded-r-lg text-black overflow-hidden">
          <div class="flex items-center justify-between border-b border-gray-50 bg-gray-50/50 px-4 py-3">
        ...
        <div id="summary" class="w-1/4 bg-white text-black rounded-l-lg overflow-hidden border-r border-gray-50">
          <h1 class="font-semibold text-lg border-b border-gray-50 bg-gray-50/50 px-4 py-3">
            خلاصه فاکتور
          </h1>
