                ...
                <div className="flex items-center">
                  ...
                  {!loading && (
                    <HandleCart
                      ...
                      btnStyle="inline-flex items-center shuffle-click sm:flex py-2 px-3 bg-brand-blue hover:opacity-70 bg-yellow-500 text-black text-xs font-semibold rounded"
