    ...
    <>
      <div class="flex flex-col justify-center">
        <div class="relative h-[390px]">
          <img class="hidden sm:block w-full h-full object-contain" src="https://picsum.photos/id/1/1080/1080" />
          <img class="sm:hidden w-full h-full object-contain" src="https://picsum.photos/id/1/1080/1080" />
