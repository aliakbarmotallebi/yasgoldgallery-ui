          ...
          <div class="flex flex-wrap -mx-4 mb-12">
            ...
            <div class="max-w-lg">
              ...
              <div class="w-full md:w-auto flex flex-wrap items-center">
                  ...
                  <button class="shuffle-click hidden sm:flex py-2 px-3 bg-brand-blue hover:bg-blue-700 text-white text-xs font-semibold rounded" data-category="components-page" data-action="click-open-in-editor">
                      افزدون به شبد
                  </button>
            </div>
