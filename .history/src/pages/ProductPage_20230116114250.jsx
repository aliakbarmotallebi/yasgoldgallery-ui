              ...
              <div class="max-w-lg">
                ...
                <div class="w-full md:w-auto flex flex-wrap items-center">
                  <div class="flex items-center rounded p-2px mr-2">
                    <a
                      class="shuffle-click hidden sm:flex py-2 px-3 bg-brand-blue hover:bg-blue-700 text-white text-xs font-semibold rounded"
                      data-category="components-page"
                      data-action="click-open-in-editor"
                    >
                      Open in Editor →
                    </a>
                  </div>
