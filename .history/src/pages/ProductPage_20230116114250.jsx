        ...
        <div class="max-w-xl lg:max-w-6xl mx-auto text-neutral-900">
          <div class="flex flex-wrap -mx-4 mb-12">
            ...
            <div class="max-w-lg">
              ...
              <div class="w-full md:w-auto flex flex-wrap items-center">
                <div class="flex items-center rounded p-2px mr-2">

                  <a class="shuffle-click hidden sm:flex py-2 px-3 bg-brand-blue hover:bg-blue-700 text-white text-xs font-semibold rounded" data-category="components-page" data-action="click-open-in-editor">
                      Open in Editor →
                  </a>
              </div>
          ...
          <div class="mb-8 border-b border-blue-600">
            <div class="flex flex-col md:flex-row -mb-px">
              <div
                class="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-black text-blue-600 border-b-2 border-blue-600"
              >
                توضیحات
              </div>
            </div>
