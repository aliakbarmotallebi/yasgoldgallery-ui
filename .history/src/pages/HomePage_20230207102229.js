      ...
      <div class="flex flex-col justify-center">
        <div class="relative h-screen overflow-hidden">
          ...
          <div class="absolute bottom-0 left-0 w-full ">
            <div class="">
              <div class="flex justify-between mx-auto px-10 translate-y-56 max-w-4xl relative z-10">
                ...
                <div class="-translate-y-4 text-center text-black">
                  <div class="w-20 h-20">
              ...
              <svg
                ...
                class="fill-white bg-transparent w-full"
