      ...
      <div class="flex flex-col justify-center">
        <div class="relative h-screen overflow-hidden">
          ...
          <div class="absolute bottom-0 left-0 w-full ">
            <div className="">
              <div className="flex justify-between mx-auto px-10 translate-y-56 max-w-4xl relative z-10">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="fill-white bg-transparent w-full" viewBox="0 0 1440 320">
