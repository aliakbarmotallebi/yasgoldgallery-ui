const Footer = () => {
    return (
        ...
        <button class="bg-gradient-radial from-purple-600 via-pink-600 to-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:opacity-60">
