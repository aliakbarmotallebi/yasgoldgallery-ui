          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 container mx-auto py-12">
            <div class="mb-6 md:mb-0">
              ...
              <div class="flex flex-wrap justify-center gap-2 pt-4">
                ...
                <button class="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:opacity-60">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-6 h-6 fill-current"
                    viewBox="0 0 24 24"
