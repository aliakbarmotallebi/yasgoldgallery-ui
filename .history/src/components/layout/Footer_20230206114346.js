                ...
                <ul class="text-white list-disc">
                  <li class="mb-4 flex items-center">
                    <a class="hover:underline after:content-[':'] flex items-center ml-1">
                      <span class="inline-flex p-1 mr-2 text-xs font-medium text-white bg-gray-100/10 rounded-lg">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="fill-current"
                          viewBox="0 0 24 24"
                  ...
                  <li class="mb-4">
                    <a class="hover:underline after:content-[':']">
                      <span class="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg"></span>
                      تلفن مدیریت
                    </a>
