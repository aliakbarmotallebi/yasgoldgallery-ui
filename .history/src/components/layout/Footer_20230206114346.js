                            ...
                            <div className="font-thin">
                                ...
                                <ul class="text-white list-disc">
                                    <li class="mb-4 flex items-center">
                                        <a class="hover:underline after:content-[':'] flex items-center ml-1">
                                            <span className="inline-flex p-1 mr-2 text-xs font-medium text-white bg-gray-100/10 rounded-lg">
