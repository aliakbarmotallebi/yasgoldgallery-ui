            ...
            <div class="grid gap-y-8 sm:gap-y-16 grid-cols-4 xl:grid-cols-3 container mx-auto py-12">
              <div class="mb-6 col-span-4 xl:col-span-1 md:mb-0">
                ...
                <div class="flex flex-wrap justify-center gap-2 pt-4">
                  <a href="https://t.me/talaayas" class="bg-[#0088cc] p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:opacity-60">
                    <svg
                  ...
                  <a href="https://instagram.com/tala._yas" class="bg-pink-600  p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:opacity-60">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="w-6 h-6 fill-current"
                      viewBox="0 0 24 24"
                  ...
                  <a href="https://eitaa.com/talaayas" class="bg-[#25d365] p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:opacity-60">
                    <svg
                      class="w-6 h-6 fill-current"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
