          ...
          <div class="grid grid-cols-1 p-4 gap-8 sm:gap-6 sm:grid-cols-3 container mx-auto py-12">
            ...
            <div>
              <div class="flex flex-col items-center">
                <span class="relative z-30 text-sm leading-none font-medium rounded text-gray-600 whitespace-no-wrap bg-gray-50">
                  <h1 class="p-3 bg-indigo-500 rounded-t text-gray-100">
                    Heading
                  </h1>
                  <p class="py-3 px-2">
                ...
                <span class="relative z-30 text-sm leading-none font-medium rounded text-gray-600 whitespace-no-wrap bg-gray-50">
                  ...
                  <div class="flex-row md:flex items-center float-right mr-2">
                    <div class="sm:space-x-2 my-3">
                      <button class="modal-close px-2 py-1 bg-gray-300 rounded-lg text-gray-600 text-sm hover:bg-gray-800  hover:text-gray-100 focus:outline-none dark:hover:bg-gray-100 dark:hover:text-gray-800">
                        Learn More
                      </button>
                      <button class="modal-close px-2 py-1 bg-indigo-600 rounded-lg text-gray-200 text-sm hover:bg-indigo-700  hover:text-gray-100 focus:outline-none dark:text-gray-100 dark:bg-gray-600 dark:hover:text-gray-50 dark:hover:bg-gray-700">
                        Got it!
                      </button>
                    </div>
                  </div>
