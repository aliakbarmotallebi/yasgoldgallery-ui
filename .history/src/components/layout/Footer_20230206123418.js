          ...
          <div class="grid grid-cols-1 p-4 gap-8 sm:gap-6 sm:grid-cols-3 container mx-auto py-12">
            ...
            <div>
              <div class="flex flex-col items-center">
                <span class="relative z-30 text-sm leading-none font-medium rounded text-gray-600 whitespace-no-wrap bg-gray-800">
                  <h1 class="p-3 rounded-t text-gray-50 bg-gray-600">
                    Heading
                  </h1>
                  <p class="py-3 px-2 text-gray-200">
                    Clear and consisce tooltip message here!
                  </p>
                  <div class="flex-row md:flex items-center float-right mr-2">
                    <div class="sm:space-x-2 my-3">
                      <button class="modal-close px-2 py-1 rounded-lg underline text-gray-300 text-sm hover:bg-gray-800  hover:text-gray-100 focus:outline-none dark:hover:bg-gray-100 dark:hover:text-gray-800">
                        Learn More
                      </button>
                      <button class="modal-close px-2 py-1 bg-indigo-200 rounded-lg text-gray-800 text-sm hover:bg-indigo-800 hover:text-gray-100 focus:outline-none dark:text-gray-100 dark:bg-gray-600 dark:hover:text-gray-50 dark:hover:bg-gray-700">
                        Got it!
                      </button>
                    </div>
                  </div>
              ...
              <div
                id="tooltip3"
                role="tooltip"
                class="shadow-lg bg-white rounded overflow-hidden"
              >
                <div class="text-sm font-bold text-gray-800 bg-yellow-400 p-2 ">
                  موقعیت فروشگاه یاس
                </div>

                <div class="text-sm font-light text-center text-black p-2">
