    ...
    <>
      {showModal ? (
        <div
          ...
          class="fixed flex items-center justify-center top-0 left-0 right-0 z-60 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full bg-black/90"
        >
          <div class="flex justify-center items-center w-fit h-fit">
            <div class="relative w-full h-full max-w-3xl md:h-auto">
              <div
                class={`relative bg-white rounded-lg shadow max-w-3/4 ${class}`}
              >
