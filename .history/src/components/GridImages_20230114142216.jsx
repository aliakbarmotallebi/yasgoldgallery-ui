      ...
      <div class="w-full max-w-7xl px-4 mx-auto sm:px-8 my-20 ">
        ...
        <div class="w-full relative flex items-center justify-center pt-5">
          <div class="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
            <div
              id="slider"
              class="h-full flex lg:gap-8  grid-cols-4 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700"
            >
              <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                <img
                  src="https://hoorgold.com/wp-content/uploads/2022/05/گردنبند-هور-640x800.jpeg"
