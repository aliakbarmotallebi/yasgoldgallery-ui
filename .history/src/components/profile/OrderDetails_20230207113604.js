...
const OrderDetails = ({ orderDetails }) => {
  ...
  return (
    <div class="max-w-5xl w-full shadow px-6 py-6 bg-white rounded-lg border mb-4">
      <div class="flex flex-col justify-between">
        ...
        <div class=" flex justify-center flex-col overflow-auto">
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 whitespace-nowrap  dark:bg-gray-700 dark:text-gray-400">
              <tr>
            ...
            <tbody class="whitespace-nowrap ">
              <tr class="bg-white print:border-y border-b hover:bg-gray-100">
                ...
                <td class="px-6 py-4 text-center">{address}</td>
