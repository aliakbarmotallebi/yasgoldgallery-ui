                ...
                <div className="relative">
                    ...
                    <div className="absolute bottom-5 right-5">
                        <button class="flex items-center bg-white  pl-2 pr-4 py-1 rounded-lg overflow-hidden shadow-lg w-full text-neutral-900 hover:bg-gray-200 font-medium">
                            ...
                            <div className="font-bold mr-auto">
                                خرید
                                <svg xmlns="http://www.w3.org/2000/svg" className="inline fill-current text-yellow-500" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M11.828 12l2.829 2.828-1.414 1.415L9 12l4.243-4.243 1.414 1.415L11.828 12z"/></svg>    
                            </div>
                        </button>
                    </div>
                </div>
