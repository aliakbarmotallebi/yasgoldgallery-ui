            ...
            <div class=" max-w-sm">
                <div className="relative">
                    <div className="w-60 h-60 overflow-hidden">
                        <a href="#">
                            <img class="shadow-md rounded-lg transition-all duration-200 hover:scale-[1.05] hover:rounded-sm hover:shadow-md hover:relative" src="https://dioragallery.com/images/stories/virtuemart/product/17427.jpg" />
                        </a>
                    </div>
