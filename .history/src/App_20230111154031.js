        ...
        <div className="grid grid-cols-5 gap-3 p-5 items-center">
          <div className=" max-w-sm">
            <div className="w-60 h-120 overflow-hidden flex justify-center">
              <img className="" src={ImageSuggest} />
            </div>
          </div>
          ...
          <div className=" max-w-sm">
            <div className="relative">
              <div className="w-60 h-60 overflow-hidden group shadow-md rounded-lg">
                <a href="#">
                  <img
                    className="transition-all duration-200 group-hover:scale-[1.05] group-hover:relative"
        ...
        <div className="grid grid-cols-5 gap-3 p-5 items-center">
          ...
          <div className=" max-w-sm">
            <div className="relative">
              ...
              <div className="absolute bottom-5 right-0 w-full px-10">
                <button className="bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow w-full text-neutral-900">
                  خرید
                </button>
              </div>
            </div>
