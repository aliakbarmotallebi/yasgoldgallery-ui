          ...
          <div class="max-w-sm">
            <div className="relative">
              ...
              <div className="absolute bottom-5 right-0 w-full mx-auto px-5">
                <button class="bg-white px-4 py-1 rounded-lg overflow-hidden shadow-lg w-full text-neutral-900 hover:bg-gray-200 font-medium">
                  <span className="text-xs ml-auto">200,000,000 تومان</span>
                  خرید
                </button>
              </div>
            </div>
