    ...
    <div className="flex flex-col mx-auto w-full min-h-screen bg-neutral-800 text-neutral-300">
      ...
      <section className="bg-neutral-900">
        ...
        <div className="grid grid-cols-5 gap-3 p-5 items-center">
          ...
          <div class="max-w-sm">
            <div className="relative">
              <div className="w-96 h-60 overflow-hidden group shadow-md rounded-lg">
                <a href="#">
                  <img
                    class="transition-all duration-200 group-hover:scale-[1.05] group-hover:relative"
                    src="https://dioragallery.com/images/stories/virtuemart/product/17427.jpg"
              ...
              <div className="absolute bottom-5 right-0 w-full mx-auto">
                <button class="bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow w-full text-neutral-900">
                  خرید
                </button>
              </div>
            </div>
