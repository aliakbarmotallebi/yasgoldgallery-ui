    ...
    <div class="flex flex-col mx-auto w-full min-h-screen bg-neutral-800 text-neutral-300">
      ...
      <section class="bg-neutral-900">
        ...
        <div class="grid grid-cols-5 gap-3 p-5">
          ...
          <div class=" max-w-sm">
            <div class="relative">
              <div class="w-60 h-60 overflow-hidden group ">
                <a href="#">
                  <img
                    class="shadow-md rounded-lg transition-all duration-200 group-hover:scale-[1.05] group-hover:relative"
              ...
              <div class="absolute bottom-5 right-5 ">
                ...
                >
                  ...
                  <svg
                    ...
                    class="inline fill-current mr-2"
                    viewBox="0 0 24 24"
                    width="24"
                    height="24"
                  >
          ...
          <div class=" max-w-sm">
            <div class="relative">
              <div class="w-50 h-50 transition-all duration-200 hover:scale-[1.02] hover:rounded-sm hover:shadow-md hover:relative">
                <a href="#">
                  <img
                    class="shadow-md rounded-lg"
                    src="https://dioragallery.com/images/stories/virtuemart/product/17427.jpg"
            ...
            <div class="px-5 pt-4">
              <a
                class="w-50 h-50 transition-all duration-200 hover:scale-[1.02] hover:rounded-sm hover:shadow-md hover:relative"
                href="#"
              >
                <h3 class="text-white font-semibold text-lg tracking-tight text-justify">
                  دستبند طلا زنانه کارتیه
