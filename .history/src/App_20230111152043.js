        ...
        <div className="grid grid-cols-5 gap-3 p-5">
            ...
            <div class=" max-w-sm">
                <div className="relative">
                    <div className="w-60 h-60 overflow-hidden group ">
                        <a href="#">
                            <img class="shadow-md rounded-lg transition-all duration-200 group-hover:scale-[1.05] group-hover:relative" src="https://dioragallery.com/images/stories/virtuemart/product/17427.jpg" />
                        </a>
                    </div>
